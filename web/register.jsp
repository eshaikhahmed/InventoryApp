<%-- 
    ...
    Created on : Feb 17, 2017, 4:44:44 PM
    Author     : EJAZ
--%>
    	      ...
    	      <h4 class="title">Create an Account</h4>
    		   <form>
    			 <div class="col_1_of_2 span_1_of_2">
		    	  ...
		    	  <div class="col_1_of_2 span_1_of_2">	
		    		<div><input type="number" name="mobile" placeholder="Mobile" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Address';}" required></div>
