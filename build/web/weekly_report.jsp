...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 <center> <h1 style="font-size: 70px;color:white;">WEEKLY REPORT </h1></center>
 <%
      DBManager db=new DBManager();
      String select_query=" SELECT * FROM   inventory WHERE  YEARWEEK(`created_date`, 1) = YEARWEEK(CURDATE(), 1)";
